          ...
          <div class="modal-body">
            <div class="detail-section">
              ...
              <div class="detail-grid">
                ...
                <div class="detail-item">
                  <span class="label">出售方：</span>
                  <span class="value">{{ selectedLedger?.sellerName }}</span>
                </div>
                <div class="detail-item">
                  <span class="label">纳税人类型：</span>
                  <span class="value">{{ selectedLedger?.sellerTaxType }}</span>
                </div>
              </div>
            </div>
            ...
            <div class="detail-section">
              ...
              <div class="detail-grid">
                <div class="detail-item">
                  ...
                  <span class="value">{{ formatDateTime(selectedLedger?.purchaseTime) }}</span>
                </div>
                <div class="detail-item">
                  <span class="label">采购地点：</span>
                  <span class="value">{{ selectedLedger?.purchaseLocation }}</span>
                </div>
                <div class="detail-item">
            ...
            <div class="detail-section">
              ...
              <div class="detail-grid">
                ...
                <div class="detail-item">
                  ...
                  <span class="value">¥{{ selectedLedger?.payableAmount }}</span>
                </div>
                <div class="detail-item">
                  <span class="label">实付金额：</span>
                  <span class="value">¥{{ selectedLedger?.paidAmount }}</span>
                </div>
              </div>
            </div>
          ...
          <div class="modal-body">
            <div class="detail-section">
              ...
              <div class="detail-grid">
                ...
                <div class="detail-item">
                  <span class="label">纳税人类型：</span>
                  <select v-model="editingLedger.sellerTaxType" class="input-field">
            ...
            <div class="detail-section">
              ...
              <div class="detail-grid">
                <div class="detail-item">
                  ...
                  <input 
                    type="datetime-local" 
                    v-model="editingLedger.purchaseTime"
                    class="edit-input"
                  />
                </div>
                <div class="detail-item">
                  ...
                  <input 
                    type="text" 
                    v-model="editingLedger.purchaseLocation"
                    class="edit-input"
                  />
                </div>
                <div class="detail-item">
            ...
            <div class="detail-section">
              ...
              <div class="detail-grid">
                ...
                <div class="detail-item">
                  ...
                  <input 
                    type="number" 
                    v-model="editingLedger.payableAmount"
                    class="edit-input"
                  />
                </div>
                <div class="detail-item">
                  ...
                  <input 
                    type="number" 
                    v-model="editingLedger.paidAmount"
                    class="edit-input"
                  />
                </div>
              </div>
...
// 模拟台账数据
// 实际使用时需要调用 ledgerApi.getAllLedgers(tenantType) 获取所有采购台账数据
const ledgers = ref([
  {
    id: 1,
    tenantType: 'nonbase',
    ...
    sellerName: '出售方B',
    sellerTaxType: '一般纳税人',
    purchaseTime: '2024-03-20T10:00:00',
    purchaseLocation: '广州',
    productName: '产品A',
    actualQuantity: 100,
  ...
  },
  {
    ...
    buyerName: '采购方C',
    sellerName: '出售方D',
    sellerTaxType: '小规模纳税人',
    purchaseTime: '2024-03-19T14:30:00',
    purchaseLocation: '深圳',
    productName: '产品B',
    actualQuantity: 200,
    priceWithoutTax: 800,
  ...
  },
  {
    ...
    sellerName: '出售方F',
    sellerTaxType: '一般纳税人',
    purchaseTime: '2024-03-18T09:15:00',
    purchaseLocation: '东莞',
    productName: '产品C',
    actualQuantity: 150,
  ...
  },
  {
    ...
    sellerName: '出售方H',
    sellerTaxType: '一般纳税人',
    purchaseTime: '2024-03-17T11:20:00',
    purchaseLocation: '佛山',
    productName: '产品D',
    actualQuantity: 300,
    priceWithoutTax: 900,
  ...
  },
  {
    ...
    sellerName: '出售方J',
    sellerTaxType: '小规模纳税人',
    purchaseTime: '2024-03-16T16:00:00',
    purchaseLocation: '惠州',
    productName: '产品E',
    actualQuantity: 250,
    priceWithoutTax: 750,
...
// 过滤后的数据
// 实际使用时需要调用 ledgerApi.getLedgersByField('searchKey', searchKey, tenantType) 进行模糊查询采购台账
...
// 搜索方法
// 实际使用时需要调用 ledgerApi.getLedgersByField('searchKey', searchKey, tenantType) 进行模糊搜索
const handleSearch = () => {
  currentPage.value = 1;
};
...
// 查看详情
// 实际使用时需要调用 ledgerApi.getLedgerDetail(id, tenantType) 获取台账详情
...
// 提交编辑
// 实际使用时需要调用 ledgerApi.updateLedger(editingLedger, tenantType) 更新台账数据
const handleSubmit = () => {
