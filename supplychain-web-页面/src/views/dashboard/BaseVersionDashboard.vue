<template>
    <div class="dashboard-content">
      <h2 class="dashboard-title">基地版仪表盘</h2>
      ...
      <template v-if="!activeModule">
        ...
        <div class="module">
          ...
          <div class="module-grid">
            <div class="module-card" @click="openOperation('inbound-weight')">
              <ScaleIcon class="card-icon" />
              <span class="card-title">入库过磅单</span>
            </div>
            <div class="module-card" @click="openOperation('inbound-quality')">
              <ClipboardCheckIcon class="card-icon" />
              <span class="card-title">入库质检单</span>
            </div>
            <div class="module-card" @click="openOperation('inbound-image')">
              <ImageIcon class="card-icon" />
              <span class="card-title">货物入库影像</span>
            </div>
            <div class="module-card" @click="openOperation('outbound-weight')">
              <ScaleIcon class="card-icon" />
              <span class="card-title">出库过磅单</span>
            </div>
            <div class="module-card" @click="openOperation('outbound-quality')">
              <ClipboardCheckIcon class="card-icon" />
              <span class="card-title">出库质检单</span>
            </div>
            <div class="module-card" @click="openOperation('outbound-image')">
              <ImageIcon class="card-icon" />
              <span class="card-title">货物出库影像</span>
            </div>
            <div class="module-card" @click="openOperation('purchase-waybill')">
              <FileTextIcon class="card-icon" />
              <span class="card-title">采购运单</span>
            </div>
            <div class="module-card" @click="openOperation('sales-waybill')">
              <FileTextIcon class="card-icon" />
        ...
        <div class="module">
          ...
          <div class="module-grid">
            <div class="module-card" @click="openOperation('purchase-settlement')">
              <CalculatorIcon class="card-icon" />
              <span class="card-title">采购结算</span>
            </div>
            <div class="module-card" @click="openOperation('sales-settlement')">
              <CalculatorIcon class="card-icon" />
  ...
  const operationTypes = {
    ...
    'sales-settlement': {
      ...
      fields: [
        ...
        { key: 'amount', label: '结算金额', type: 'number' },
        { key: 'settlementDate', label: '结算日期', type: 'date' },
        { key: 'paymentMethod', label: '收款方式', type: 'text' },
        { key: 'status', label: '结算状态', type: 'text' }
      ]
    },
    // 其他操作类型定义...
  ...
  const recognizeDocument = () => {
    ...
    setTimeout(() => {
      ...
      } else if (currentOperation.value.key === 'inbound-weight') {
        uploadForm.details = {
