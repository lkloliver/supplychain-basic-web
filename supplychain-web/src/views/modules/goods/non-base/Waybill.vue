<template>
    <div class="operation-page">
      <div class="operation-header">
        <router-link :to="{ name: 'FactoryWeight' }" class="back-btn">
          <ArrowLeftIcon class="back-icon" />
          <span>返回</span>
        </router-link>
        <h2 class="operation-title">到货厂家过磅单</h2>
      </div>
      
      <div class="operation-tabs">
        <router-link 
          :to="{ name: 'FactoryWeightUpload' }" 
          custom
          v-slot="{ isActive }"
        >
        ...
        <div class="upload-form">
          ...
          <div class="form-group">
            ...
            <div class="detail-fields">
              ...
              <div class="detail-field">
                <label for="field-factory">到货厂家</label>
                <input 
                  type="text" 
                  id="field-factory" 
                  v-model="uploadForm.details.factory" 
                  placeholder="请输入到货厂家" 
                />
              </div>
              <div class="detail-field">
  ...
  const submitUpload = () => {
    ...
    // 上传成功后跳转到管理页面
    router.push({ name: 'FactoryWeightManage' });
  };
  </script>
