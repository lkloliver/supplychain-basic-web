<template>
    <div class="operation-page">
      <div class="operation-header">
        <router-link :to="{ name: 'OutboundWeight' }" class="back-btn">
          <ArrowLeftIcon class="back-icon" />
          <span>返回</span>
        </router-link>
        <h2 class="operation-title">出库过磅单</h2>
      </div>
      
      <div class="operation-tabs">
        <router-link 
          :to="{ name: 'OutboundWeightUpload' }" 
          custom
    ...
    const documents = ref([
    {
      id: 1,
      name: '2023年1月出库过磅单',
      type: 'outbound-weight',
      uploadTime: '2023-01-20 14:30',
      details: {
        weightNo: 'OW-2023-001',
        customer: '客户A',
        grossWeight: '45000',
        tareWeight: '5000',
        netWeight: '40000',
        weightDate: '2023-01-20'
      }
    },
    {
      id: 2,
      name: '2023年2月出库过磅单',
      type: 'outbound-weight',
      uploadTime: '2023-02-15 09:45',
      details: {
        weightNo: 'OW-2023-002',
        customer: '客户B',
        grossWeight: '38000',
        tareWeight: '4500',
        netWeight: '33500',
        weightDate: '2023-02-15'
      }
    }
    ]);
