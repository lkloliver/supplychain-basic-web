<template>
    <div class="operation-page">
      <div class="operation-header">
        <router-link :to="{ name: 'PurchaseLedger' }" class="back-btn">
          <ArrowLeftIcon class="back-icon" />
          <span>返回</span>
        </router-link>
        <h2 class="operation-title">采购台账</h2>
      </div>
      
      <div class="operation-tabs">
        <router-link 
          :to="{ name: 'PurchaseLedgerUpload' }" 
          custom
          v-slot="{ isActive }"
        >
        ...
        <div class="upload-form">
          ...
          <div class="form-group">
            ...
            <div class="detail-fields">
              ...
              <div class="detail-field">
                <label for="field-paidAmount">已��金额</label>
                <input 
                  type="number" 
                  id="field-paidAmount" 
                  v-model="uploadForm.details.paidAmount" 
                  placeholder="请输入已付金额" 
                />
              </div>
              <div class="detail-field">
  ...
  const submitUpload = () => {
    ...
    // 上传成功后跳转到管理页面
    router.push({ name: 'PurchaseLedgerManage' });
  };
  </script>
