<template>
    <div class="operation-page">
      <div class="operation-header">
        <router-link :to="{ name: 'SalesReceipt' }" class="back-btn">
          <ArrowLeftIcon class="back-icon" />
          <span>返回</span>
        </router-link>
        <h2 class="operation-title">销售收款记录</h2>
      </div>
      
      <div class="operation-tabs">
        <router-link 
          :to="{ name: 'SalesReceiptUpload' }" 
          custom
          v-slot="{ isActive }"
        >
          ...
          <div class="form-group">
            ...
            <div class="detail-fields">
              <div class="detail-field">
                <label for="field-receiptNo">收款单号</label>
                <input 
                  type="text" 
                  id="field-receiptNo" 
                  v-model="uploadForm.details.receiptNo" 
                  placeholder="请输入收款单号" 
                />
              </div>
              <div class="detail-field">
              ...
              <div class="detail-field">
                <label for="field-amount">收款金额</label>
                <input 
                  type="number" 
                  id="field-amount" 
              ...
              <div class="detail-field">
                <label for="field-receiptDate">收款日期</label>
                <input 
                  type="date" 
                  id="field-receiptDate" 
                  v-model="uploadForm.details.receiptDate" 
                />
              </div>
              <div class="detail-field">
                <label for="field-receiptMethod">收款方式</label>
                <select id="field-receiptMethod" v-model="uploadForm.details.receiptMethod">
  ...
  const submitUpload = () => {
    ...
    // 上传成功后跳转到管理页面
    router.push({ name: 'SalesReceiptManage' });
  };
  </script>
