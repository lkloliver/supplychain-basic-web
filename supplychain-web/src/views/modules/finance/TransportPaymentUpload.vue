<template>
    <div class="operation-page">
      <div class="operation-header">
        <router-link :to="{ name: 'TransportPayment' }" class="back-btn">
          <ArrowLeftIcon class="back-icon" />
          <span>返回</span>
        </router-link>
        <h2 class="operation-title">运输付款记录</h2>
      </div>
      
      <div class="operation-tabs">
        <router-link 
          :to="{ name: 'TransportPaymentUpload' }" 
          custom
          v-slot="{ isActive }"
        >
        ...
        <router-link 
          :to="{ name: 'TransportPaymentManage' }" 
          custom
          ...
          <div class="form-group">
            ...
            <div class="detail-fields">
              <div class="detail-field">
                <label for="field-paymentNo">付款单号</label>
                <input 
                  type="text" 
                  id="field-paymentNo" 
                  v-model="uploadForm.details.paymentNo" 
                  placeholder="请输入付款单号" 
                />
              </div>
              <div class="detail-field">
                <label for="field-transporter">运输商</label>
                <input 
                  type="text" 
                  id="field-transporter" 
                  v-model="uploadForm.details.transporter" 
                  placeholder="请输入运输商" 
                />
              </div>
              <div class="detail-field">
              ...
              <div class="detail-field">
                <label for="field-amount">付款金额</label>
                <input 
                  type="number" 
                  id="field-amount" 
              ...
              <div class="detail-field">
                <label for="field-paymentDate">付款日期</label>
                <input 
                  type="date" 
                  id="field-paymentDate" 
                  v-model="uploadForm.details.paymentDate" 
                />
              </div>
              <div class="detail-field">
                <label for="field-paymentMethod">付款方式</label>
                <select id="field-paymentMethod" v-model="uploadForm.details.paymentMethod">
  ...
  const submitUpload = () => {
    ...
    // 上传成功后跳转到管理页面
    router.push({ name: 'TransportPaymentManage' });
  };
  </script>
